...
export function WorkPage() {
  ...
  const sortedProjects = [...liveProjects].sort((a, b) => {
      ...
      <section className="px-6 pb-16 pt-48 sm:px-8 lg:px-12 bg-transparent">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="max-w-xl text-white/60 text-base sm:text-lg leading-relaxed font-sans mb-8">
